...
X=[spine_base(:,1), spine_mid(:,1), NaN(T,1), head(:,1),markers.LSHO(:,1), markers.LELB(:,1), markers.LWRA(:,1), NaN(T,1),...
...
Y=[spine_base(:,2),spine_mid(:,2), NaN(T,1), head(:,2),markers.LSHO(:,2), markers.LELB(:,2), markers.LWRA(:,2), NaN(T,1),...
